...
### scatter plot, temp as a function of sal 
...
ggplot(cofi, aes(x=sal, y=depth, col=temp)) + 
  geom_point() +
  labs(x="Salinity", y="Depth(m)", col = "Temperature(C)")+
  theme_classic()

ggplot(cofi, aes(x=sal, y=log10(depth), col=temp)) + 
  geom_point() +
  labs(x="Salinity", y="log10(Depth(m))", col = "Temperature(C)")+
  theme_classic()
```
